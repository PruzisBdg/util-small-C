...
void test_BCDle_toU64(void)
{
   ...
   S_Tst const tsts[] = {
      ...
      // Fails. Try each byte in turn. If a fail then 'out' should be unmodified.
      { .src = (U8[]){0x7A, 0x28, 0x91, 0x50, 0x78, 0x56, 0x34, 0x12}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
      { .src = (U8[]){0x72, 0xC8, 0x91, 0x50, 0x78, 0x56, 0x34, 0x12}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
      { .src = (U8[]){0x72, 0x28, 0x9A, 0x50, 0x78, 0x56, 0x34, 0x12}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
      { .src = (U8[]){0x72, 0x28, 0x91, 0x5F, 0x78, 0x56, 0x34, 0x12}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
      { .src = (U8[]){0x72, 0x28, 0x91, 0x50, 0xA8, 0x56, 0x34, 0x12}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
      { .src = (U8[]){0x72, 0x28, 0x91, 0x50, 0x78, 0xFF, 0x34, 0x12}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
      { .src = (U8[]){0x72, 0x28, 0x91, 0x50, 0x78, 0x56, 0x0F, 0x12}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
      { .src = (U8[]){0x72, 0x28, 0x91, 0x50, 0x78, 0x56, 0x34, 0x1B}, .numBytes = 8, .rtn = false, .res = 0x5A5A5A5A5A5A5A5AULL },
   };
